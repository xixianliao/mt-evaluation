#!/bin/bash
#SBATCH --job-name=bouquet_paragraph_eval_v3
#SBATCH --error=slurm_logs_xixian/bouquet_paragraph_eval_v3_%j.err
#SBATCH --output=slurm_logs_xixian/bouquet_paragraph_eval_v3_%j.out
#SBATCH -q acc_debug
#SBATCH -c 20
...
model='/gpfs/projects/bsc88/mt_translation/instructed_models/salamandraTA_7b_v3_mixture1_final/'
#model='/gpfs/projects/bsc88/mt_translation/instructed_models/salamandraTA_7b_extended_mixture1_v3/checkpoint-11934'

model_name_dir='salamandraTA_7b_v3_mixture1_final_newHF'
